...
//
// v1.2.5 bug fix: random seed was indeed in intended range, but never seen by functions intended to see them,
// becuase I used a local variable of the same name. Fixed that to use the global variable.
String versionString = "v1.2.5";
...
int intOverrideSeed = -161287680;    // a favorite is: -161287680
...
int minimumColumns = 1; int maximumColumns = 25;
...
void save_image() {
  ...
  // -- WINDOWS:
  saveFrame("C:\\Users\\SMOFA_guest\\Dropbox\\By_Small_and_Simple_Things__SMOFA_visitor_image_saves\\" + explanatory_img_name);
  // -- MAC:
   //saveFrame("/Users/earthbound/Dropbox/By_Small_and_Simple_Things__SMOFA_visitor_image_saves/" + explanatory_img_name);
...
//TO DO? : control the folling rnd range with parameters?
    milliseconds_elapse_to_color_morph = (int) random(46, 111);    // on more powerful hardware, 194 is effectively true. On slower? Cut by ~1/5?
