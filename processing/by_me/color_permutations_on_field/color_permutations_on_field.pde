// DESCRIPTION
// creates color observation fields of all possible permutations of a list of colors (choosing 3 colors from the list),
// after a color obserervation field model diagram I found for the CIECAM02 color observation model.

// USAGE
// paste a list of RGB hex color codes into the array. Press go. It makes SVGs of all 3-permutations of those colors.
