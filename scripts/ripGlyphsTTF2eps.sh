...
# you may compile it via ttf2eps.c, included in this repo. I have a win32-or-64 binary
# of it in _ebSuperBin.

# USAGE
# Invoke with one parameter, being the name of a true-type font file in the same directory from which you call this script; e.g.:
...
epsArray=(`gfind . -maxdepth 1 -type f -iname \*.eps -printf '%f\n'`)
