//EITHER overwrite convertColors.js with this file (run "which convertColors.js" to find it), or, if you can (I couldn't), get svgo to recognize this as a legitimate config file. The only changes from the default config at this writing are:
    // shorthex: false,
    // shortname: false
