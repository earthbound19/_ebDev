...
# USAGE
# From a path where you wish to list all files that include the offset string _FINAL_ in them, run without any parameters:
#    findAllFinals.sh
...
if [ "$1" ]
	then	# if no parameter passed to script, search for .*FINAL.* :
