# DESCRIPTION
# Converts a fountain format plain text file screenplay into a fountain file _with semantic
# linefeeds (AKA ventilated prose or sense lines) joined_. Adapted from fountain2pdf.sh.
# output file is <input-filename_unventilated.fountain>.
...
cat tmp_head_wYSNpHgq.fountain tmp_tail_wYSNpHgq.fountain > "$fileNameNoExt"-unventilated.fountain 
