# DESCRIPTION
# Permanently deletes all files in path $1 (parameter one, intended to be a different directory from the one you run this script in) which are in the directory this script is run from. Warns you and asks you to type password to confirm.
