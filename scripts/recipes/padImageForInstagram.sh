...
# DEPENDENCIES
# getDoesIMGinstagram.sh, color-thief-jimp-palette.js, padImage.py, and their various dependencies. (Yeesh, this is a frankenassembly that uses three different scripting languages.)
...
then
	...
	paletteExtractorScriptPath=$(command -v color-thief-jimp-palette.js)
	...
	padImageScriptPath=$(command -v padImage.py)
