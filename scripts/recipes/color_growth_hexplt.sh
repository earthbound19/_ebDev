...
# uncomment the next line to add these optional additional arguments:
...
do
	...
	then
		...
		echo "python $pathToScript --WIDTH 200 --HEIGHT 100 --RSHIFT $rshiftParam -b [$rgbValForParam] -c [$rgbValForParam] --RECLAIM_ORPHANS True --BORDER_BLEND True --TILEABLE False --STOP_AT_PERCENT 1 -a 0 --RANDOM_SEED $rndSeedValForParam -q 1 --GROWTH_CLIP \($lowGrowthClipParam,$highGrowthClipParam\) --SAVE_PRESET True $extraArgs" > RUN_this__gQThHuC5RTeeRn.sh
		./RUN_this__gQThHuC5RTeeRn.sh
