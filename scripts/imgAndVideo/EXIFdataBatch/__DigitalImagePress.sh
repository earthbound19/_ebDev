# DESCRIPTION
# Invokes a series of scripts to prepare and embed metadata in final exported (pre-publication) art etc. files.
...
# - Comment out steps unecessary for your current run of the image press (this script). Then run the script.
...
# - Move the relevant instructions from below, or all of them, into
#  echo statements in the files to which they relate, for cases of using
#  those files independent of this script.
