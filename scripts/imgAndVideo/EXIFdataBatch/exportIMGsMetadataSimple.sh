# DESCRIPTION
# For all of many image types in the current directory, creates textfiles of simplified metadata information, named after the image.

# USAGE
# Hack the image list in the list= variable assignment per your preferences, and invoke the script.
