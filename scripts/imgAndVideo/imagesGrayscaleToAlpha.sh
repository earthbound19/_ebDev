# DESCRIPTION
# Converts white or gray pixels to alpha transparency in images, using graphicsmagick
# - removes existing alpha channels from input images
# - creates alpha from luminance values (whiter becomes more transparent (white is fully transparent), blacker becomes more opaque (black is opaque)
# - optional fuzz parameter for matching near-white colors
# - supports single file processing or batch processing by file extension
# - can overwrite original file or create copy with _alpha suffix
