# DESCRIPTION
# invokes paletteCompareCIECAM02.py repeatedly, for every .hexplt (list of RGB colors in hex hex format) pair in the current directory, printing the results to paletteDifferenceRankings.txt.
...
# blank/create new palettesListByMostSimilar.txt:
printf "" > palettesListByMostSimilar.txt
