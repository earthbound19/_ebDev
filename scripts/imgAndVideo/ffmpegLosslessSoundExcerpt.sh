...
# ./thisScript.sh inputFile.m4a 12 30
...
# CODE
# TO DO: update all scripts that extract to variables fileNameNoExt etc. to use this far more elegant method found at: https://www.cyberciti.biz/faq/unix-linux-extract-filename-and-extension-in-bash/
fileExt=`echo "${1##*.}"`
