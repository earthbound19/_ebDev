# DESCRIPTION
# Takes a flat file list of display (and/or multi-display) resolutions
# in format NNNNxNNNN, one per line, and calculates and prints their
# aspects and number of pixels to:
...
# NOTE: you may want to be sure there are no duplicate lines in the source list.

# DEPENDENCIES
# such a list in the currend directory, named 
# export_resolutions_list.txt

# USAGE
# With this script in your path, invoke it, with the mentioned
# export_resolutions_list.txt file in your current
# directory:
