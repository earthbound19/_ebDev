...
# DEPENDENCY
# ImageMagick installed in your PATH, copyMetadataFromSourceFileToTarget.sh.
...
then
	...
	printf "Will attempt to copy metadata from source $sourceIMG to target $renderTarget . . . \n"
	copyMetadataFromSourceFileToTarget.sh $sourceIMG $renderTarget YIUHL
