# DESCRIPTION
# Resizes all images of type T (via parameter $1) in the current path, by
...
# Invokes img2imgNN.sh repeatedly to do this.

# USAGE
# This script uses the same parameters as img2imgNN.sh, EXCEPT that
# parameter $1 is a file type instead of a specific file. All files
# of type $1 will be passed to imgs2imgsNN.sh.
# PARAMETERS:
# $1 source file type.
