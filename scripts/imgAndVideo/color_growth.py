...
faster, contributed by one GitHub user "scribblemaniac," is in this same directory as
color_growth_fast.py. For now they are separate scripts; I may determine to paste over this
one with that after testing.
