...
# NOTES
# - CHARSET may be altered in the source code to be any characters which the toolset may handle (possibly Unicode). See comments in `randomNsetChars.sh` for additional ideas.
