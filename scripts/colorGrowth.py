...
# TO DO:
# - Debug that in fact one bacterium is doing a random walk at this writing, by having it walk half the range of the pixel array and mutate color. IN PROGRESS.
...
def getRNDunusedCoord():
	...
	print('Unused coordinates remaining: ', unusedCoordsListSize)
