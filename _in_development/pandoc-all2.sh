IN DEVELOPMENT. Canna seem to get this to work as intended on Windows, although swapping in literals in the gfind .. command (instead of parameters) _does_ work.
exit
...
# DEPENDENCIES
# pandoc, gfind, a 'nix environment with exec and basename.
