...
class Coordinate:
	__slots__ = ["x", "y", "RGBcolor", "isAlive", "isConsumed", "unoccupiedNeighbors"]
	def __init__(self, x, y, RGBcolor, isAlive, isConsumed, unoccupiedNeighbors):
...
for yCoord in range(0, width):
	for xCoord in range(0, height):
		allCoordinates.append(Coordinate(yCoord, xCoord, mediumPurplishGray, False, False, None))
